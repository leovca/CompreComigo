import './announcements.show.component.css';

export const AnnouncementShowComponent  = {
    template: require('./announcements.show.component.html'),
    controllerAs: 'vm',
    controller: class AnnouncementShowComponent {
