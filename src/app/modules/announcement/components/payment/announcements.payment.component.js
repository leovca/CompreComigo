import './announcements.payment.component.css';

export const AnnouncementPaymentComponent  = {
    template: require('./announcements.payment.component.html'),
    controllerAs: 'vm',
    controller: class AnnouncementPaymentComponent {
